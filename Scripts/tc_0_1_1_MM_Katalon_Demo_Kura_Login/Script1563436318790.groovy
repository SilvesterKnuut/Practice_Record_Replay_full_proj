...
WebUI.setText(findTestObject('tc_0_1_1_MM_OR/Page_CURA Healthcare Service/input_Username_username'), 'John Doe')

WebUI.setText(findTestObject('tc_0_1_1_MM_OR/Page_CURA Healthcare Service/input_Password_password'), 'ThisIsNotAPassword')
